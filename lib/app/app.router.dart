...
import 'package:resavation/ui/views/property_owner_step2/property_owner_step_1_3_view.dart';
...
class Routes {
  ...
  static const String propertyOwnerStep_1_3View = '/propertyOwnerStep_1_3View';
...
class StackedRouter extends RouterBase {
  ...
  final _routes = <RouteDef>[
    ...
    RouteDef(Routes.propertyOwnerStep_1_3View, page: PropertyOwnerStep_1_3View),
  ];
  @override
  ...
  final _pagesMap = <Type, StackedRouteFactory>{
    ...
    PropertyOwnerStep_1_3View: (data) {
      return buildAdaptivePageRoute<dynamic>(
        builder: (context) => const PropertyOwnerStep_1_3View(),
        settings: data,
      );
    },
  };
